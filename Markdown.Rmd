...
The value of a predicted by the iterations doesn't converge to the true value but does appear to converge to the Least Squares model with increasing iterations. I do notice that the histogram for a becomes more sharply peaked as well as the fact that the true estimate is bettered centered towards the middle of the plot of chain. This effect is observed as one transitions both between 1000 iterations with 500 burnIn to 10000 iterations with 5000 burnIn, as well as between the latter and 100000 with 50000 burnIn.